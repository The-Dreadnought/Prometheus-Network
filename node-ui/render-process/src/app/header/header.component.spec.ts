  ...
  describe('clicking the settings button', () => {
    ...
    describe('clicking the settings link', () => {
      ...
      it('opens the beta survey link in an external browser', () => {
        ...
        expect(stubElectronService.shell.openExternal).toHaveBeenCalledWith('https://github.com/The-Dreadnought/Prometheus-Network/issues');
      });

      it('opens the documentation link in an external browser', () => {
        compiled.querySelector('#documentation').click();

        expect(stubElectronService.shell.openExternal).toHaveBeenCalledWith('https://github.com/The-Dreadnought/Prometheus-Network');
      });
